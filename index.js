...
const app = express();
const port = Number(process.env.PORT || 3000); // set the environment variable PORT to tell your web server what port to listen on,
...
// setup email data
    ...
    let mailOptions = {
        ...
        subject: 'Cloudunit new test part 2.',
